...
public class NaverSVC {
	...
	private final static String REDIRECT_URI = "http://146.56.44.116:8080/oauth/naver";
	...
	public void insertNaverUser(OAuth2AccessToken oauthToken,Model model) throws Exception{
		OAuth20Service oauthService =new ServiceBuilder()
		.apiKey(CLIENT_ID)
		.apiSecret(CLIENT_SECRET)
		.callback(REDIRECT_URI).build(NaverLoginApi.instance());
